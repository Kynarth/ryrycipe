...
public class MaterialManager {
     ...
     * {@link ryrycipe.controller.CreatorPaneController#materialFilter}.
     *
     * @param parameters {@link Map} containing each value of
     * {@link ryrycipe.controller.CreatorPaneController#materialFilter}'s controls.
     * @return {@link List} of {@link Material}s fitting
     * {@link ryrycipe.controller.CreatorPaneController#materialFilter}'s parameters.
     * @see CreatorPaneController#getFilterParameters()
     */
    public static List<Material> filter(Map<String ,String> parameters) {
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                List<Component> components = ComponentManager.findMaterialComponents(resultSet.getString("material_id"));
